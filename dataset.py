...
class Normal_Loader(Dataset):
    ...
    """
    def __init__(self, is_train=1, path='Dataset/workspace/DATA/UCF-Crime/'):
        ...
        if self.is_train == 1:
            ...
            data_list = os.path.join(path, 'test_nomarl.txt')
            with open(data_list, 'r') as f:
                self.data_list = f.readlines()
...
if __name__ == '__main__':
    # loader2 = Normal_Loader(is_train=1)
    loader= Anomaly_Loader(is_train=0)
    print(loader)
